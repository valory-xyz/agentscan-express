...
CREATE INDEX "context_embeddings_name_idx" ON "context_embeddings" USING gin (to_tsvector('english'::regconfig, "name"));--> statement-breakpoint
...
CREATE INDEX "idx_context_embeddings_type" ON "context_embeddings" USING btree ("type" text_ops);--> statement-breakpoint
...
CREATE INDEX "idx_users_privy_did" ON "users" USING btree ("privy_did" text_ops);